...
final class CommonCapabilityRegistrar {
    ...
    static void register(RegisterCapabilitiesEvent event) {
        ...
        registerPoweredItemEnergyStorage(event, DEItems.PORTABLE_DIGITAL_STORAGE_CELL_1K.get());
        registerPoweredItemEnergyStorage(event, DEItems.PORTABLE_DIGITAL_STORAGE_CELL_4K.get());
        registerPoweredItemEnergyStorage(event, DEItems.PORTABLE_DIGITAL_STORAGE_CELL_16K.get());
        registerPoweredItemEnergyStorage(event, DEItems.PORTABLE_DIGITAL_STORAGE_CELL_64K.get());
        registerPoweredItemEnergyStorage(event, DEItems.PORTABLE_DIGITAL_STORAGE_CELL_256K.get());
        registerPoweredItemEnergyStorage(event, DEItems.PORTABLE_DIGITAL_STORAGE_CELL_1M.get());
        registerPoweredItemEnergyStorage(event, DEItems.PORTABLE_DIGITAL_STORAGE_CELL_4M.get());
