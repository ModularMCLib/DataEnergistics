...
import com.fish_dan_.data_energistics.mixin.magic.botania.AlfheimPortalAccessor;
import com.fish_dan_.data_energistics.mixin.magic.botania.RunicAltarAccessor;
...
public final class BotaniaMachineAdapter implements PackagedMachineAdapter {

    private final BotaniaMachineKind kind;

    public BotaniaMachineAdapter(BotaniaMachineKind kind) {
        this.kind = kind;
    }
