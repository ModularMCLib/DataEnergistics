package com.fish_dan_.data_energistics.integration.crafting.packaged.technology.mekanismmore;
...
public final class LargeMachineAdapter implements PackagedMachineAdapter {

    private final LargeMachineKind kind;

    public LargeMachineAdapter(LargeMachineKind kind) {
        this.kind = kind;
    }
